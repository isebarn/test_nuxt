...
output "app_subnet_ids" {
  ...
  value       = var.create_public_only ? null : aws_subnet.app_private[*].id
}

output "db_subnet_ids" {
  description = "List of DB Tier Private Subnet IDs"
  value       = var.create_public_only ? null : aws_subnet.db_private[*].id
}

output "misc_subnet_ids" {
  description = "List of MISC Tier Private Subnet IDs"
  value       = var.create_public_only ? null : aws_subnet.misc_private[*].id
}
...
output "app_private_route_table_ids" {
  ...
  value       = var.create_public_only ? null : aws_route_table.app_private[*].id
}

output "db_private_route_table_ids" {
  description = "List of DB tier Private Route Table IDs"
  value       = var.create_public_only ? null : aws_route_table.db_private[*].id
}

output "misc_private_route_table_ids" {
  description = "List of MISC tier Private Route Table IDs"
  value       = var.create_public_only ? null : aws_route_table.misc_private[*].id
}
...
output "flow_log_arn" {
  description = "ARN of VPC Flow Log"
  value       = one(aws_flow_log.this[*].arn)
}

output "flow_log_log_group_arn" {
  description = "ARN of the Cloudwatch Group of VPC Flow Log"
  value       = one(aws_cloudwatch_log_group.this[*].arn)
}

output "flow_log_iam_role_arn" {
  description = "ARN of the IAM Role of Flow Log"
